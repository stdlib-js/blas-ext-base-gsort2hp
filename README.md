...
```javascript
gsort2hp = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsort2hp@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsort2hp@v0.3.1-umd/browser.js"></script>
```
