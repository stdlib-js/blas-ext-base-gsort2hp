...
```javascript
import gsort2hp from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gsort2hp@v0.3.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gsort2hp/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-gsort2hp/actions/workflows/test.yml?query=branch:v0.3.1
